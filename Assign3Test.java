...
public class Assign3Test {
	...
	public static void main(String[] args) {
		...
		/*
		 * System.out.println("Total number of students majoring in Computer Science: "
		 * + myStudentList.getStudentCount("CS")); System.out.
		 * println("Total number of students majoring in Software Engineering: " +
		 * myStudentList.getStudentCount("SE"));
		 * System.out.println("Total number of students majoring in History: " +
		 * myStudentList.getStudentCount("HIS"));
		 */
